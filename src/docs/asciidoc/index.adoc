...
include::{snippets}/gateway/{macAddress}/asRequest/http-request.adoc[]

==== 1.6.2 http 응답 예제

include::{snippets}/gateway/{macAddress}/asRequest/http-response.adoc[]

==== 1.6.3 요청 바디 예제

include::{snippets}/gateway/{macAddress}/asRequest/request-body.adoc[]
